const en = {
  ...
  'tasks-running': '{0} task(s) running',
  'tasks-errored': '{0} task(s) failed',
  'tasks-done': 'Done',
  'tasks-expand': 'Show tasks',
  'tasks-collapse': 'Collapse',
  'tasks-title': 'Tasks',
  'tasks-clear-finished': 'Clear finished',
  'tasks-idle': 'No task running',
  'task-done': 'Done',
  'task-cancelling': 'Cancelling…',
  'task-waiting': '{0} waiting',
  'task-failed': 'Failed: {0}',
  'dismiss': 'Dismiss',
  'task-import': 'Import',
  'task-musics-transfer': 'Transferring music',
  'task-stories-transfer': 'Transferring stories',
  'task-store-download': 'Store download',
  'task-store-build': 'Building a pack',
  'task-stories-optimize': 'Audio optimization',
  'task-stories-merge': 'Merging stories',
  ...
  'filter-all-on-device': 'Everything is already on the box.',
  'add-files': 'Add files',
  ...
  'column-date': 'Date',
  'podcast-search': 'Search a podcast',
  'podcast-search-placeholder': 'Podcast name, or Spotify/RSS link…',
  'podcast-search-empty': 'No podcast found. Try another name, or add the RSS feed manually.',
  'store-add-manual': 'Add by URL (RSS feed or store)',
