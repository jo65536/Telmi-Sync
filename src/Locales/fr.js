const fr = {
  ...
  'tasks-running': '{0} tâche(s) en cours',
  'tasks-errored': '{0} tâche(s) en erreur',
  'tasks-done': 'Terminé',
  'tasks-expand': 'Voir les tâches',
  'tasks-collapse': 'Réduire',
  'tasks-title': 'Tâches',
  'tasks-clear-finished': 'Vider les finies',
  'tasks-idle': 'Aucune tâche',
  'task-done': 'Terminé',
  'task-cancelling': 'Annulation…',
  'task-waiting': '{0} en attente',
  'task-failed': 'Échec : {0}',
  'dismiss': 'Fermer',
  'task-import': 'Importation',
  'task-musics-transfer': 'Transfert de musiques',
  'task-stories-transfer': 'Transfert d\'histoires',
  'task-store-download': 'Téléchargement depuis un store',
  'task-store-build': 'Création d\'un pack',
  'task-stories-optimize': 'Optimisation audio',
  'task-stories-merge': 'Fusion d\'histoires',
  ...
  'filter-show-all': 'Tout afficher',
  'filter-all-on-device': 'Tout est déjà sur la boîte.',
  ...
  'column-age': 'Âge',
  'column-author': 'Auteur',
  'column-updated': 'Mise à jour',
  'column-downloads': 'Téléch.',
  'column-date': 'Date',
  'podcast-search': 'Rechercher un podcast',
  'podcast-search-placeholder': 'Nom du podcast, ou lien Spotify/RSS…',
  'podcast-search-empty': 'Aucun podcast trouvé. Essayez un autre nom, ou ajoutez le flux RSS manuellement.',
  'store-add-manual': 'Ajouter par URL (flux RSS ou store)',
